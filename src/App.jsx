...
import { formatearDinero, calcularDinero } from '../helpers'
...
function App() {
  ...
  useEffect(() => {
     const resultadoTotalPagar = calcularDinero(cantidad,meses);
  ...
  function handleChange (e){
     setCantidad(+e.target.value)  //modificamos la cantidad a travez del evento
  }
